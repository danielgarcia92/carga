...
<div class="card card-custom">
    ...
    <div class="card-header flex-wrap border-0 pt-6 pb-0">
        ...
        <div class="card-toolbar">
            ...
            <a href="{{ url('/uploads') }}" class="btn btn-primary font-weight-bolder">
    ...
    <div class="card-body">
        <ul class="nav nav-tabs md-tabs" id="myTab" role="tablist">
            <li class="nav-item">
                <a href="#approved-md" class="nav-link active" id="approved-tab-md" data-toggle="tab" role="tab" aria-controls="approved-md"
                   aria-selected="true">Aprobadas</a>
            </li>
            <li class="nav-item">
                <a href="#pending-md" class="nav-link" id="pending-tab-md" data-toggle="tab" role="tab" aria-controls="pending-md"
                   aria-selected="false">Pendientes</a>
            </li>
            <li class="nav-item">
                <a href="#rejected-md" class="nav-link" id="rejected-tab-md" data-toggle="tab" role="tab" aria-controls="rejected-md"
                ...
                <table class="table table-striped">
                    ...
                    @foreach($approved as $appr)
                        <tr>
                            ...
                            <form method="POST" action="{{ url("viva_requests/{$appr->id}") }}" novalidate>
                                {{ csrf_field() }}
                ...
                <table class="table table-striped">
                    ...
                    @foreach($pending as $pend)
                        <tr>
                            ...
                            <form method="POST" action="{{ url("viva_requests/{$pend->id}") }}" novalidate>
                                {{ csrf_field() }}
                ...
                <table class="table table-striped">
                    ...
                    @foreach($rejected as $rej)
                        <tr>
                            ...
                            <form method="POST" action="{{ url("viva_requests/{$rej->id}") }}" novalidate>
                                {{ csrf_field() }}
