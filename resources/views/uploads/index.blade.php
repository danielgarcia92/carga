    ...
    <div class="mx-auto w-50 card">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ url('uploads') }}" class="needs-validation" enctype="multipart/form-data" novalidate>
                ...
                <div class="form-group">
                    <label for="legcd">Código de pierna</label>
                    <input type="text" class="form-control" id="legcd" name="legcd" placeholder="Ejm: D" maxlength="1" value="{{ old('legcd') }}"/>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="volume">Volumen (MC)</label>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="description" name="description" rows="3" maxlength="100">{{ old('description') }}</textarea>
                </div>
                <div class="form-group">
                    <label for="assurance">* Método de aseguramiento</label>
                    <textarea class="form-control" id="assurance" name="assurance" rows="3" maxlength="100">{{ old('assurance') }}</textarea>
                </div>
                <div class="form-group">
